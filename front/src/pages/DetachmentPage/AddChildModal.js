...
import { getPendingApplications, confirmApplication, rejectApplication } from '../../services/applications';
...
export default function AddChildModal({
    ...
    }, [activeTab, campId, loadApplications]);
                                    ...
                                    {applications.map(app => (
                                        <div key={app.id} className="application-card">
                                            ...
                                            <div className="app-info">
                                                ...
                                                <div className="app-meta" style={{ marginTop: '6px' }}>
                                                    {app.parentName && <><span>Родитель: {app.parentName}</span></>}
                                                    {app.relation && <><span>·</span><span>Связь: {app.relation}</span></>}
                                                </div>
                                                ...
                                                {(app.specialNeeds || app.behavioralNotes) && (
                                                    <div className="app-health">
                                                        {app.specialNeeds && <span>🧩 {app.specialNeeds}</span>}
                                                        {app.behavioralNotes && <span>📝 {app.behavioralNotes}</span>}
                                                    </div>
                                                )}
                                            </div>
