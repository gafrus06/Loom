...
export const methodologyAPI = {
    ...
    getGames: async (detachmentId, stage) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/games?stage=${stage}`,
            { method: 'GET' }
        );
    ...
    getCampfires: async (detachmentId, stage) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/campfires?stage=${stage}`,
            { method: 'GET' }
        );
    ...
    getExercises: async (detachmentId, stage) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/exercises?stage=${stage}`,
            { method: 'GET' }
        );
    ...
    getPhysiologicalFeatures: async (ageGroup) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/methodology/physiological/${encodeURIComponent(ageGroup)}`,
            { method: 'GET' }
        );
    ...
    markAsUsed: async (detachmentId, materialId, materialType, stage, notes = '') => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/usage`,
            {
                method: 'POST',
                body: JSON.stringify({
                    materialId,
    ...
    getRecommendedForStage: async (detachmentId, stage) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/recommended?stage=${stage}`,
            { method: 'GET' }
        );
    ...
    getUsageHistory: async (detachmentId) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/usage/history`,
            { method: 'GET' }
        );
    ...
    addToFavorites: async (detachmentId, materialId, materialType) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/favorites`,
            {
                method: 'POST',
                body: JSON.stringify({
                    materialId,
    ...
    removeFromFavorites: async (detachmentId, materialId, materialType) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/favorites/${materialType.toUpperCase()}/${materialId}`,
            { method: 'DELETE' }
        );
    ...
    getFavorites: async (detachmentId, materialType) => {
        ...
        const response = await authFetch(
            `${HOST}/api/detachments/${detachmentId}/methodology/favorites/${materialType.toUpperCase()}`,
            { method: 'GET' }
        );
